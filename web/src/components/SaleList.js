...
function SaleList({ sales, deleteSale, editSale, multiplyNumbers, capitalizeWord, sortByDate }) {
	return (
		<div className="col ">
									...
									<tbody>
										<tr className="row-hover">
											...
											<td
												...
												aria-controls="collapseExample"
											>
												{sale.customer ? sale.customer.firstName : "Customer unknown"}{" "}
										...
										<tr className="test" >
											<td  className="test w-100">
												<form>
													id: <input type="text" defaultValue={sale._id} /> <br/>
													date:{" "}
													<input
														type="date"
														defaultValue={Date.parse(sale.date).toString(
															"yyyy-MM-dd"
														)}
													/>
													<br />
													location: <input type="text" defaultValue={sale.type} />
													{sale.products.map(s => {
														return (
															<div>
                                                <hr/>
																<input type="text" defaultValue={s.product._id} />
																<span>({s.product.title})</span>
                                                <br/>
																<span>salePrice: <input type="number" defaultValue={s.salePrice}/> </span>
                                                <br/>
																<span>salePrice: <input type="number" defaultValue={s.unitAmount}/> </span>
                                                <br/>
                                                <hr/>
															</div>
														);
                                       ...
                                       customer
													<input type="text" defaultValue={sale.customer._id} /> ({
