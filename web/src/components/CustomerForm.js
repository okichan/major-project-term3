      ...
      {customers && (
        ...
        >
          <div className="form-group radio" id="radio">
            ...
            <div className="form-check form-check-inline">
              <label className="form-check-label">
                <input required className="form-check-input" value="male" type="radio" name="gender" />
          ...
          <div className="form-group">
            ...
            <input className="form-control" type="text" placeholder="Tomomi" name="firstName" />
          </div>
          ...
          <div className="form-group">
            <label>Email</label>
            <input className="form-control" type="email" placeholder="test@gmail.com" name="email" />
          </div>

          <div className="form-group">
            <label>Phone</label>
            <input className="form-control" type="text" placeholder="0412345678" name="phone" />
          </div>
            ...
            {Object.keys(customerOriginPicks).map((key, index) => {
              return (
                <div className="form-check m-2" key={index}>
                  ...
                  <input type="radio" className="form-check-input"  value={key} name="origin" key={index} />
